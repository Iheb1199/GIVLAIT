...
<head>
  ...
  <title id="tt-pg">GIVLAIT | Réglementations</title> 
  ...
  <nav>
      <ul id="br-nav">
        ...
        <li class="item-nav parent"><span class="it-hv"><a href="index.php#Programmes" id="item-pg">Programmes</a><img class="ic-dp" src="images/dropdown.png"></span>
          <div class="fils" id="dp-pg">
            <a href="#br-nav" id="item-rg" class="item-dp" style="color: black; font-size:15px;font-weight:bold;"><img class="icr-dp" src="images/right-arrow.png">Réglementations</a>
          </div>
        </li>
    ...
    <div id="ctn-ft">  
        <div id="liens-ft" class="item-ft"> 
          ...
          <a href="#br-nav" id="li-rg" class="slien lien">Réglementations</a>
...
<script type="text/javascript"> 
  ...
  { 
    ...
    ttpg.innerHTML = "GIVLAIT | القوانين";        
  ...
  if (sessionStorage.getItem("crlp") !== null && sessionStorage.getItem("pagrg") === 'oui') 
  {
      window.scrollTo(0, parseInt(sessionStorage.getItem("crlp"))); 
  }
  else if (sessionStorage.getItem("crlp") !== null) 
    sessionStorage.setItem("crlp", null); 
  sessionStorage.setItem("pagrg", "oui"); 
  window.addEventListener("scroll", function(){
    const scrollPosition = window.scrollY || window.pageYOffset;  
    sessionStorage.setItem('crlp', scrollPosition.toString());
  });
